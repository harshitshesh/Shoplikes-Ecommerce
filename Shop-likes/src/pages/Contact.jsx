        ...
        <div className='flex flex-col md:flex-row gap-20 py-20 border-t border-neutral-100'>
          ...
          <div className='flex-1 space-y-12'>
            <div>
              ...
              <a href="mailto:hello@shoplikes.com" className='text-3xl md:text-5xl font-[fontnormal] hover:text-[#c0e067] transition-colors'>
                hello@shoplikes.com
              </a>
            </div>
            ...
            <div>
              ...
              <p className='text-2xl md:text-3xl font-[fontnormal] leading-relaxed'>
          ...
          <div className='flex-1 flex flex-col justify-between'>
            <div className='space-y-6'>
              ...
              <div className='flex flex-col gap-2 text-2xl md:text-3xl font-[fontnormal]'>
            ...
            <p className='mt-20 text-neutral-400 italic text-xl'>
